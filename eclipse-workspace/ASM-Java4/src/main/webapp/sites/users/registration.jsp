...
<div class="col-8 offset-2">
	...
	${Routes.SITE__REGISTRATION_SHOW }
		<div class="card">
					...
					<div class="col">
						...
						<div class="form-group">
							<label for="fullname">Fullname</label> <input type="text"
								...
								id="fullnameId" class="form-text text-muted" value="${user.fullname }">Fullname is
								required</small>
						</div>
					</div>
					<div class="col">
						...
						<div class="form-group">
							<label for="email">Email</label> <input type="text"
								...
								aria-describedby="emailId" placeholder="Email" value="${user.email }"> <small
